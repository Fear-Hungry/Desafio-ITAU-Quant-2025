...
from arara_quant.costs.transaction_costs import transaction_cost_vector
...
from arara_quant.optimization.heuristics.hrp import heuristic_allocation
from arara_quant.portfolio.cardinality_pipeline import apply_cardinality_constraint
from arara_quant.portfolio.rounding import RoundingResult, rounding_pipeline
    ...
    *,
    ...
    if baseline_cfg_raw:
        ...
        if mv_config.turnover_cap is not None and mv_config.turnover_cap > 0:
            from arara_quant.backtesting.risk_monitor import apply_turnover_cap
