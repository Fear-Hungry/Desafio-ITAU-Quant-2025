...
from arara_quant.costs.cost_model import CostModel, estimate_costs_by_class
...
def apply_cardinality_constraint(
    ...
    if mode == "fixed_k":
        ...
        from arara_quant.optimization.heuristics.cardinality import suggest_k_from_neff
