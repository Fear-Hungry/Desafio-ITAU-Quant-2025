...
2. **Processing:** `arara_quant.runners.reporting.consolidate_oos_metrics`
...
- **docs/standards/CVAR_CONVENTION.md:** Complete CVaR calculation reference
- **docs/reports/CVAR_STANDARDIZATION_SUMMARY.md:** Standardization details
...
poetry run python -m arara_quant.runners.reporting.generate_final_report
...
**Generated by:** arara_quant.runners.reporting.generate_final_report
"""
