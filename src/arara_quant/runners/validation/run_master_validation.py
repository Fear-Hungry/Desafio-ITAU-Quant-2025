...
Usage:
    ...
    poetry run python -m arara_quant.runners.validation.run_master_validation --resume-from stage3
...
PRIMARY_CONFIGS = [
    "configs/optimization/optimizer_example.yaml",
    "configs/optimization/optimizer_regime_aware.yaml",
    "configs/optimization/optimizer_adaptive_hedge.yaml",
]

SENSITIVITY_SCRIPTS = [
    "arara_quant.runners.research.run_cost_sensitivity",
    "arara_quant.runners.research.run_window_sensitivity",
    "arara_quant.runners.research.run_covariance_sensitivity",
]

VALIDATION_SCRIPTS = [
    "arara_quant.runners.validation.run_comprehensive_tests",
    "arara_quant.runners.validation.run_constraint_tests",
    "arara_quant.runners.validation.run_estimator_tests",
    "arara_quant.runners.validation.run_sensitivity_tests",
]
...
class ValidationOrchestrator:
    ...
    def stage1_data_pipeline(self) -> bool:
        ...
        cmd = [
            ...
            "python",
            "-m",
            "arara_quant.runners.core.run_01_data_pipeline",
            "--force-download",
            "--start",
            "2010-01-01",
        ]
    ...
    def stage4_sensitivity_analyses(self) -> bool:
        ...
        for module in SENSITIVITY_SCRIPTS:
            script_name = module.split(".")[-1]
    ...
    def stage5_validation_suite(self) -> bool:
        ...
        for module in VALIDATION_SCRIPTS:
            script_name = module.split(".")[-1]
