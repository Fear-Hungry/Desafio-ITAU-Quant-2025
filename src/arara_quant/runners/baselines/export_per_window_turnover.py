...
Usage
    poetry run python -m arara_quant.runners.baselines.export_per_window_turnover \
...
DEFAULT_CONFIGS = SETTINGS.configs_dir
DEFAULT_REPORTS = SETTINGS.reports_dir
DEFAULT_RESULTS = SETTINGS.results_dir
DEFAULT_DATA = SETTINGS.processed_data_dir

DEFAULT_OOS_CONFIG = DEFAULT_CONFIGS / "oos_period.yaml"
DEFAULT_UNIVERSE = DEFAULT_CONFIGS / "universe" / "universe_arara.yaml"
...
def main() -> None:
    ...
    parser.add_argument(
        ...
        help="Universe YAML (tickers list). Default: configs/universe/universe_arara.yaml",
    )
    parser.add_argument(
        "--oos-config",
        type=str,
