...
Uses the OOS returns produced by `arara_quant.runners.research.run_baselines_comparison` to estimate
...
def latest_oos_returns() -> Path:
    ...
    raise FileNotFoundError(
        ...
        "`arara_quant.runners.research.run_baselines_comparison` primeiro."
    )
