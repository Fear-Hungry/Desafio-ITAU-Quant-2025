...
The goal is to avoid divergence between research runners and production code.
"""
...
DEFAULT_CONFIG = REPO_ROOT / "configs" / "optimization" / "optimizer_example.yaml"
...
def build_parser() -> argparse.ArgumentParser:
    ...
    parser.add_argument(
        ...
        help="Path to backtest configuration YAML (default: configs/optimization/optimizer_example.yaml)",
    )
    parser.add_argument(
        "--no-wf-report",
        dest="wf_report",
