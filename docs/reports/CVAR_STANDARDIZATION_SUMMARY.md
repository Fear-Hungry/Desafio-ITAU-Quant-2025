...
|------|---------|---------|
| `docs/standards/CVAR_CONVENTION.md` (NEW) | Complete reference | 211-line comprehensive guide |
| `docs/guides/MONITORING_CHECKLIST.md` (L241) | Expected metrics | `-0.8% a -1.2%` → `-12.7% a -19.0% (equiv. -0.8% a -1.2% diário)` |
| `docs/report/REPORT_OUTLINE.md` (L6, L42, L50, L58) | Report structure | Updated all CVaR references to annualized |

---

## New CVaR Convention Reference (`docs/standards/CVAR_CONVENTION.md`)
...
4. **docs/standards/CVAR_CONVENTION.md:** Complete reference (this standardization)
