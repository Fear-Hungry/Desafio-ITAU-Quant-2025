...
poetry run python -m arara_quant.runners.production.run_portfolio_production_erc_v2 > run1.txt
poetry run python -m arara_quant.runners.production.run_portfolio_production_erc_v2 > run2.txt
